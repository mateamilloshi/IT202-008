...
<h1>Assign Roles</h1>
<form method="POST">
    <input type="search" name="username" placeholder="Username search" style="margin-left:40px;" />
...
<form method="POST">
    ...
    <input type="submit" value="Toggle Roles" style="margin-top:10px; margin-left:40px;" />
</form>
<?php
//note we need to go up 1 more directory
